...
const WishlistCard = ({ image, name, id }) => {
  ...
  return (
    <div
      key={id}
      className='outline-none p-2 sm:p-0 w-1/2 h-60 sm:h-60 sm:w-40 md:w-48 relative transition-all duration-150 rounded-lg sm:shadow-xl cursor-pointer min-[1800px]:w-52 wish-card md:h-72 group sm:hover:shadow-cyan-800 sm:hover:shadow-2xl hover:scale-95'
    >
      <FaTrash
