...
const SearchBar = () => {
  ...
  return (
    <div
      className={`lg:relative mt-4 lg:mt-0 ${
        isMenuOpen ? 'relative' : 'absolute bottom-0'
      }`}
    >
      <AiFillCloseCircle
      ...
      />
      <input
        className={`relative text-sm mt-16 mb-8 lg:mb-0 lg:mt-0 border-[2px] border-transparent w-full pl-6 pr-10 py-1.5 mx-auto bg-[#141414] rounded-full outline-none text-white focus-visible:border-white lg:gap-9 transition-all duration-300 ${opacity}`}
        type='text'
        placeholder='Search...'
        value={value}
